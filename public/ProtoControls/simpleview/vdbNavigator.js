                ...
                require(['/public/uccello/uses/template.js', 'text!./ProtoControls/simpleview/templates/dbNavigator.html'], function(template, tpl){
                    ...
                    if (editor.length == 0) {
                        ...
                        editor.find('.dragRight').click(function () {
                            vcomp.toParent.apply(that, [vcomp]);
                        });
                        // перейти к чайлду
                        editor.find('.dragLeft').click(function () {
                            vcomp.toChild.apply(that, [vcomp]);
                        });
                        // перейти к чайлду
                        editor.find('.refresh').click(function () {
                            vcomp.render.apply(that);
                        });
                    }
                        ...
                        for (var i = 0, len = that.params.db.countRoot(); i < len; i++) {
                            ...
                            var link = leftTpl.find('a')
                                ...
                                .click(function () {
                                    ...
                                    a.addClass('active');
                                    vcomp.selectItem.apply(that, [a.data('obj'), vcomp]);
                                    return false;
                                });
                            left.append(leftTpl);
                        }
                        vcomp.selectFirst.apply(that, vcomp);
                    }
                });
            },

            toParent: function (vcomp) {
                    ...
                    for (var i = 0, len = obj.countCol(); i < len; i++) {
                        ...
                        var link = centerTpl.find('a')
                            ...
                            .click(function () {
                                ...
                                a.addClass('active');
                                vcomp.selectCol.apply(that, [a.data('obj'), vcomp]);
                                return false;
                            });
                        centerTop.append(centerTpl);
                    }
                vcomp.selectFirst.apply(this, [1]);
            },

            selectCol: function (obj, vcomp) {
                this._activeCol = obj;
                this._activeObj = null;
                ...
                for (var i = 0, len = obj.count(); i < len; i++) {
                    ...
                    var link = centerTpl.find('a')
                        ...
                        .click(function () {
                            ...
                            a.addClass('active');
                            vcomp.selectObj.apply(that, [a.data('obj'), vcomp]);
                            return false;
                        });
