		...
		var MemMetaObj = MemProtoObj.extend({
			...
			init: function(parent, flds){
				...
				/*if (parent.rtype == "data")
					...
					this.pvt.rtype = "res";
				*/
				if ((flds.$sys.guid == "87510077-53d2-00b3-0032-f1245ab1b74d") || (flds.$sys.guid == "73596fd8-6901-2f90-12d7-d1ba12bae8f4") || (flds.$sys.guid == "59583572-20fa-1f58-8d3f-5114af0f2c51"))
					this.pvt.rtype = "data";
				else
					this.pvt.rtype = "res";
				//if (classGuid
