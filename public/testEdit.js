define(
    [],
    function() {
        var TestEditDataset = Class.extend({
            ...
            clickNext: function(edit) {
                ...
                cm.getByName('DatasetCompany').next();
            },

            clickPrev: function(edit) {
                var cm = this.pvt.uccelloClt.getContextCM();
                cm.getByName('DatasetCompany').prev();
            },
            ...
            _dataset: function () {
                var cm = this.pvt.uccelloClt.getContextCM();
                return cm.getByName('DatasetCompany');
            },
